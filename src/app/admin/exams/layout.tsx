...
export default async function AdminExamsLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <main className="min-h-screen bg-[#f5f7fb] text-slate-950 lg:grid lg:grid-cols-[280px_1fr]">
      ...
      <div className="min-w-0">
        <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/95 px-4 py-4 backdrop-blur sm:px-6 lg:px-8">
          ...
          <h2 className="mt-1 text-xl font-black text-[#071f4a]">จัดการข้อมูลข้อสอบ</h2>
        </header>
